...
import { camion_table, campaign_table, cart_session_table, categories_table, clientes_table, compras_table, pedidos_table, productos_comprasstock_table, productos_pedidos_table, productos_table, productos_ventas_table, proveedores_table, stock_camion_campaign_producto_table, stock_camion_campaign_table, subcategories_table, users_table, ventas_table } from './querysTables';
...
export async function initDatabase() {
    ...
    if(!res){
        ...
        await createTables(db, pedidos_table);
        await createTables(db, productos_pedidos_table);
