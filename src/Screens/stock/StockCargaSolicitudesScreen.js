...
import { getProductosSolicitudesStockFetch } from '../../services/fetching';
import Footer from '../../components/Footer';


const StockCargaSolicitudesScreen = ({ route }) => {
    ...
    const getProductosSolicitudesStock = async () => {



        setIsLoading(true);
        const productos = await getProductosSolicitudesStockFetch(idcampaign, idcammioncampaign);
                ...
                <SafeAreaView style={styles.box_content}>
                    <ScrollView style={styles.scrollview}>
                        ...
                        <ItemsProductosStockBox productos={dataProducto} setIsLoading={setIsLoading} idstockcamioncampaign={idcammioncampaign}
                            reload={reload} setReload={setReload} funcion={2}></ItemsProductosStockBox>
...
export default StockCargaSolicitudesScreen
